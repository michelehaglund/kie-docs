...
https://docs.jboss.org/drools/release/latestFinal/drools-docs/html_single/#decision-examples-central-con_getting-started-decision-services[{PRODUCT_DROOLS} documentation]
