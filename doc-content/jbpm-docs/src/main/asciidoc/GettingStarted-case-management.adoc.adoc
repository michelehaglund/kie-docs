...
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-it-order-sample-proc.adoc[leveloffset=+1]
...
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-creating-a-case-proc.adoc[leveloffset=+1]
include::{jbpm-dir}/GettingStartedCaseManagement/data-objects-con.adoc[leveloffset=+1]
include::{jbpm-dir}/GettingStartedCaseManagement/order-service-data-object-proc.adoc[leveloffset=+2]
include::{jbpm-dir}/GettingStartedCaseManagement/survey-data-object-proc.adoc[leveloffset=+2]

include::{jbpm-dir}/GettingStartedCaseManagement/case-management-designing-IT-hardware-proc.adoc[leveloffset=+1]
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-create-sub-proc.adoc[leveloffset=+2]
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-creating-manager-approval-proc.adoc[leveloffset=+2]
//include::{enterprise-dir}/cases/case-management-creating-business-proc.adoc[leveloffset=+2]
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-milestones-con.adoc[leveloffset=+1]
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-creating-hardware-spec-ready-proc.adoc[leveloffset=+2]
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-creating-manager-decision-milestone-proc.adoc[leveloffset=+2]

include::{jbpm-dir}/GettingStartedCaseManagement/case-management-creating-order-placed-milestone-proc.adoc[leveloffset=+2]
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-creating-order-shipped-milestone-proc.adoc[leveloffset=+2]
include::{jbpm-dir}/GettingStartedCaseManagement/case-management-creating-delivered-milestone-proc.adoc[leveloffset=+2]

include::{jbpm-dir}/GettingStartedCaseManagement/case-management-deploy-test-proc.adoc[leveloffset=+1]
