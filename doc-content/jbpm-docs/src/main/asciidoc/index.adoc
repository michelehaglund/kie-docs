...
include::GettingStarted-business-proc.adoc[leveloffset=+1]
include::GettingStarted-case-management.adoc[leveloffset=+1]
...
include::Design-and-building-cases.adoc[leveloffset=+1]
include::Using-showcase-app.adoc[leveloffset=+1]
