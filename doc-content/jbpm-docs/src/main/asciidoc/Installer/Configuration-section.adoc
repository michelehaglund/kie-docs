...
[NOTE]
====
If you use MySQL 5.7 or earlier (MariaDB 10.2.3 or earlier), you also need to run [path]_jbpm-installer/db/ddl-scripts/mysql5/mysql-jbpm-amend-auto-increment-procedure.sql_
...
|install.business-central.into.jboss
