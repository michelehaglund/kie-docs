...
** *MI Collection input*: Select a variable that represents a collection of elements for which new instances are created. For example, the subprocess is instantiated as many times as the size of the collection.
