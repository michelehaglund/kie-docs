...
* *Abort Parent*: If selected, non-independent, reusable subprocesses can abort the parent process. This property is only visible when the *Independent* property is not selected. The following rules apply:
