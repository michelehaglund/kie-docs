...
.The *Data I/O* of a reusable subprocess does not return any implicit data [https://issues.redhat.com/browse/RHPAM-3429[RHPAM-3429]]

Issue: When you use the *Data I/O* variables such as `nodeInstance`, `event`, and `workItem`, a reusable subprocess does not return any implicit data. All the returned values are null.
