...
*Michele Haglund regarding a tutorial, I think we should still use what we got in here, the IT Order example. In my opinion, I think the document as it is now is mixing general instructions for case management, a walk through the IT Order project and actually building it. Perhaps if we break down the content that would help in making it clear. For example, a guided step by step on how to build the IT Order example. The other benefit I see is that people would still have the sample project to compare with that they built. Maciej Swiderski wdyt? Maciej Swiderski added a comment - 9 hours ago Cristiano Nicolai agreed, it would make it more clear and easier to follow to have it broken down like you suggested.*
