...
{PRODUCT} includes the *IT_Orders* sample project in {CENTRAL}. This project is referred to throughout this document to explain case management concepts and provide examples. You can import the project in {CENTRAL}, deploy the project to the {KIE_SERVER}, and start *IT_Orders* cases using this project using the Showcase application.
...
* {EAP_LONG} 7.2.0 installed. See  https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.2/html-single/installation_guide/[_Red Hat JBoss EAP 7.2.0 Installation Guide_].
...
* The Showcase application is deployed. For information about how to install and log in to Showcase, see {URL_USING_SHOWCASE_APPLICATION}[_{USING_SHOWCASE_APPLICATION}_].
