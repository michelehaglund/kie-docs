...
==== Smart router
The smart router (also known as kie-server-router) can be used as a proxy to help manage multiple independent process execution servers. *<MH>Emily may know if the smart router is needed for DM</MH>*
...
== Business Optimizer - Reword throughout!
