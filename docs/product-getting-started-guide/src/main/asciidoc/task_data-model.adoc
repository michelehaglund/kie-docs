...
<MH> Ivo, it may be overkill, but would a simple illustration showing the flow of a Data Model comprised of a couple of data objects, and the data-object-specific fields?</MH>"
...
<MH> Ivo, can we clarify the need for these fields for our readers?</MH>
