...
The following chapter instructs you how to test the driver license suspension scenario for drivers with multiple violations the data that you specified when you set the Driver License Suspension rules and actions.
