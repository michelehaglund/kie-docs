...
The following chapter instructs you how to test the driver license suspension scenario for drivers with multiple violations using the traffic violation data model and its assigned rules.
