...
:MAVEN_ARTIFACT_VERSION: 7.23.0.Final-redhat-00003
:BOM_VERSION: 7.4.0.GA-redhat-00003
...
:DESIGNING_BUSINESS_PROCESSES: Designing a business process in {CENTRAL}
...
:URL_DESIGNING_BUSINESS_PROCESSES: {URL_BASE_ENTERPRISE}/designing_a_business_process_in_{URL_COMPONENT_CENTRAL_UNDER}
:URL_BPMN2_REFERENCE_GUIDE: {URL_BASE_ENTERPRISE}/bpmn_reference
...
:URL_DEPLOYING_MANAGED_FIXED_ON_OPENSHIFT: {URL_BASE_ENTERPRISE}/deploying_a_{URL_COMPONENT_PRODUCT}_managed_fixed_server_environment_on_red_hat_openshift_container_platform
:URL_DEPLOYING_MANAGED_FREEFORM_ON_OPENSHIFT: {URL_BASE_ENTERPRISE}/deploying_a_{URL_COMPONENT_PRODUCT}_managed_freeform_server_environment_on_red_hat_openshift_container_platform
endif::PAM[]
ifdef::DM[]
