...
:REBUILT: Thursday, November 1, 2018

:ENTERPRISE_VERSION: 7.2
:COMMUNITY_VERSION: 7.14
:ENTERPRISE_VERSION_SHORT: 72
...
:MAVEN_ARTIFACT_VERSION: 7.14.0.Final-redhat-00004
:BOM_VERSION: 7.2.0.GA-redhat-00004
...
:INSTALLING_ON_EAP: Installing and configuring {PRODUCT} on {EAP}
:INSTALLING_ON_EAP_CLUSTER: Installing and configuring {PRODUCT} in a {EAP} clustered environment
:USING_THE_SHOWCASE_APPLICATION_FOR_CASE _MANAGEMENT: Using the Showcase application for case management
...
:URL_SHOWCASE_APPLICATION_CASE_MANAGEMENT: {URL_BASE_ENTERPRISE}/assembly_case-management-showcase
...
:URL_INSTALLING_ON_EAP: {URL_BASE_ENTERPRISE}/installing_and_configuring_{URL_COMPONENT_PRODUCT}_on_red_hat_jboss_eap
