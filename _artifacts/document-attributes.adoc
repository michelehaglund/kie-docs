...
:USING_SHOWCASE_APPLICATION: Using the Showcase application for case management
...
:URL_USING_SHOWCASE_APPLICATION: {URL_BASE_ENTERPRISE}/using_the_showcase_application_for_case_management
